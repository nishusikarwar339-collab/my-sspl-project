  ...
  const features = [
    {
      ...
      description:
        "Deliver critical OTPs, payment confirmations, and order milestones with sub-second latency across all primary channels.",
    },
    {
      icon: <Zap className="text-purple-500" size={24} />,
      title: "Strategic Marketing & Omnichannel Campaigns",
      description:
        "Execute high-volume marketing campaigns via Email, WhatsApp, and SMS simultaneously to maximize brand visibility and impact.",
    },
    {
      icon: <Users className="text-purple-500" size={24} />,
      title: " Enterprise-Grade Integration & Scalability",
      description:
        "Seamlessly bridge EWS with your existing tech stack (CRM, ERP, or e-commerce) via our high-performance, developer-friendly APIs.",
    },
    {
      icon: <BarChart3 className="text-purple-500" size={24} />,
      title: " Actionable Intelligence & Delivery Analytics",
      description:
        "Gain deep insights with real-time tracking of delivery success, open rates, and click-through conversions across all channels.",
    },
  ];
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-gray-400 text-lg leading-relaxed max-w-xl">
                  Fragmented communication leads to missed opportunities. EWS
                  (Email, WhatsApp, SMS) is a sophisticated, no-code unified
                  messaging platform by Shakuniya Solutions.
                </p>
              </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className=" min-h-[500px]">
              <div className="relative w-full max-w-3xl">
                ...
                {/* Video */}
                <video
                  src="/videos/ewsvideo.mp4" // put video in public/videos/
                  autoPlay
                  loop
                  muted
                  playsInline
