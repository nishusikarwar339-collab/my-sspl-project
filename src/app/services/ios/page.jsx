...
const iosFeatures = [
  ...
  },
  {
    ...
    description:
      "We provide customized app development for iOS to satisfy our client’s specifications and business requirements. By understanding the interface functionalities we customize your app with top features.",
  },
  {
    icon: TestTube,
